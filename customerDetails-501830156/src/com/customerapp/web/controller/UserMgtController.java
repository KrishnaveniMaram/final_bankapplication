...
public class UserMgtController {
	...
	//@PostConstruct
	public void init() {
		userService.addUser(new User("kittu", "kittu@gmail.com", "kittu123", "admin",
				true));
		userService.addUser(new User("bharu", "bharu@gmail.com", "bharu123", "mgr",
				true));
		userService.addUser(new User("ratna", "ratna@gmail.com", "ratna123",
				"emp", true));
	}
